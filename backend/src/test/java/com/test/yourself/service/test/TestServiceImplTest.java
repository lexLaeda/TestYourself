...
public class TestServiceImplTest {
    ...
    public void getTestByQuestions() {
        ...
        com.test.yourself.model.testsystem.test.Test test = new com.test.yourself.model.testsystem.test.Test();
        com.test.yourself.model.testsystem.test.Test randomTest = testService.getRandomTest(6L, 5);
